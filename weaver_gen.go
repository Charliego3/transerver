...
func init() {
	codegen.Register(codegen.Registration{
		...
		RefData: "⟦bbd1ec6e:wEaVeReDgE:github.com/ServiceWeaver/weaver/Main→github.com/charliego93/transerver/Reverser⟧\n⟦1c67c58a:wEaVeRlIsTeNeRs:github.com/ServiceWeaver/weaver/Main→endpoint⟧\n",
	})
	codegen.Register(codegen.Registration{
		Name:  "github.com/charliego93/transerver/Reverser",
		Iface: reflect.TypeOf((*Reverser)(nil)).Elem(),
		Impl:  reflect.TypeOf(reverser{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return reverser_local_stub{impl: impl.(Reverser), tracer: tracer, reverseMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/charliego93/transerver/Reverser", Method: "Reverse", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return reverser_client_stub{stub: stub, reverseMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/charliego93/transerver/Reverser", Method: "Reverse", Remote: true})}
		},
		ServerStubFn: func(impl any, addLoad func(uint64, float64)) codegen.Server {
